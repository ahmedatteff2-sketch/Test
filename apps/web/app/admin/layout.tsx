  ...
  return (
    <div className="flex h-screen overflow-hidden bg-bg">
      ...
      <motion.aside
        ...
        className="flex flex-col border-e border-border bg-surface h-full overflow-hidden"
      >
        {/* Logo */}
        <div className="flex items-center gap-3 px-5 py-6 border-b border-border">
          <div className="w-8 h-8 rounded-[var(--radius-sm)] bg-accent flex items-center justify-center shrink-0">
            <span className="font-display font-bold text-bg text-sm">E</span>
          </div>
          {!collapsed && (
            <motion.span
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="font-display font-bold text-lg text-text-1"
            >
              EAGLE
            </motion.span>
          )}
